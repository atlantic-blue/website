...
const Peacock: React.FC<PeacockProps> = props => {
    return (
        <svg
            {...props}
            ...
            viewBox="0 0 114 35"
            aria-hidden="true">
            <use xlinkHref="#pwob_a" fill="#069de0"></use>
            <use xlinkHref="#pwob_a" y="-5.747" fill="#6e55dc"></use>
            <use xlinkHref="#pwob_a" y="5.745" fill="#05ac3f"></use>
            <use xlinkHref="#pwob_a" y="-11.492" fill="#ef1541"></use>
            <use xlinkHref="#pwob_a" y="-17.239" fill="#ff7112"></use>
            <path
            ...
            <path
                ...
                fill="url(#pwob_b)"></path>
            <use xlinkHref="#pwob_c" fill="url(#pwob_d)"></use>
            <use xlinkHref="#pwob_c" fill="url(#pwob_e)"></use>
            <path
                d="M19.377 19.612h10.669l-.016-.033-1.683-1.631-9.296.015a4.4 4.4 0 0 0 .326 1.649z"
                fill="url(#pwob_f)"></path>
            <path
            ...
            <path d="M46.091 11.137h-1.779v13.781h1.779V11.137z" fill="url(#pwob_m)"></path>
            <use xlinkHref="#pwob_n" fill="url(#pwob_o)"></use>
            <use xlinkHref="#pwob_n" fill="url(#pwob_p)"></use>
            <use xlinkHref="#pwob_q" fill="url(#pwob_r)"></use>
            <path
            ...
            <path
                ...
                fill="url(#pwob_t)"></path>
            <use xlinkHref="#pwob_n" x="29.626" fill="url(#pwob_u)"></use>
            <use xlinkHref="#pwob_q" x="29.626" fill="url(#pwob_r)"></use>
            <path d="M95.251 3.631h-1.802v21.286h1.802V3.631z" fill="#fff"></path>
            <path
                d="m98.367 17.731-.031-.039-1.187 1.248.027.039-.003.003 4.095 5.935h2.031l-4.932-7.186z"
                fill="url(#pwob_v)"></path>
            <path
            ...
            <path
                ...
                fill="url(#pwob_w)"></path>
            <path d="M93.51 3.631h-1.728v21.286h1.728V3.631z" fill="url(#pwob_x)"></path>
            <defs>
                <linearGradient
                    id="pwob_b"
                    x1=".273"
                ...
                <path
                    id="pwob_a"
                    d="M111.832 22.984a2.1 2.1 0 0 0-2.099 2.098 2.1 2.1 0 0 0 2.099 2.098 2.1 2.1 0 0 0 2.098-2.098 2.1 2.1 0 0 0-2.098-2.098z"></path>
                <path
                    id="pwob_c"
                    d="M7.317 10.757A7.33 7.33 0 0 0 0 18.074V35h1.659V18.034c0-3.126 2.532-5.655 5.658-5.655s5.659 2.527 5.659 5.655a5.6 5.6 0 0 1-1.766 4.1c-.005.005-.544.538-2.194 1.258l-5.464 2.292 1.184 1.259 5.096-1.996c2.914-1.136 4.802-3.744 4.802-6.873a7.33 7.33 0 0 0-7.318-7.317z"></path>
                <path
                    id="pwob_i"
                ...
                <path
                    id="pwob_n"
                    d="M54.746 14.004a3.74 3.74 0 0 1 3.378 2.044l1.384-1.062c-1.02-1.677-2.805-2.718-4.75-2.718-3.085 0-5.636 2.611-5.636 5.791s2.551 5.815 5.636 5.815c1.96 0 3.771-1.08 4.787-2.786l-1.42-1.089a3.745 3.745 0 0 1-3.378 2.044c-2.22 0-3.848-1.771-3.848-4.018s1.667-4.019 3.847-4.019z"></path>
                <path
                    id="pwob_q"
                    d="M54.757 23.839c-3.03 0-5.611-2.586-5.611-5.782s2.59-5.778 5.611-5.778c1.93 0 3.724 1.021 4.75 2.705l1.327-1.017a7.316 7.316 0 0 0-6.089-3.264 7.33 7.33 0 0 0-7.317 7.317 7.33 7.33 0 0 0 7.317 7.317 7.316 7.316 0 0 0 6.089-3.264l-1.291-.989c-1.02 1.713-2.887 2.754-4.785 2.754z"></path>
            </defs>
        </svg>
    )
}
